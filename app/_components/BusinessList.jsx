...
const BusinessList = ({businessList, title}) => {
  ...
  return (
    <div className='mt-5'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-col-4 gap-6 mt-5 '>{
        businessList.length>0?businessList.map((business, index)=>(
         <div key={index} className='shadow-sm rounded-lg hover:shadow-lg hover:shadow-primary cursor-pointer
